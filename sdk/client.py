...
class Client(object):
    ...
    def listAllDesigns4(self):
        ...
        # url = f"{self.baseUrl}/DesignService/ListAllDesigns4?LanguageKey=en&ListAllTrainingDesignVersion=413"
        url = f"{self.baseUrl}/DesignService/ListAllDesigns4?LanguageKey=en&ListFileVersion=2057&ListSpriteVersion=2768&ListBackgroundVersion=470&ListAllShipDesignVersion=635&ListRoomDesignVersion=831&ListAllCharacterDesignVersion=1059&ListAllCharacterDesignActionVersion=368&ListItemDesignVersion=164146&ListCraftDesignVersion=447&ListMissileDesignVersion=520&ListStarSystemVersion=328&ListStarSystemLinkVersion=324&ListAllNewsDesignVersion=314&ListLeagueVersion=432&ListAchievementDesignVersion=550&ListRoomDesignPurchaseVersion=659&ListRoomDesignSpriteVersion=711&ListAllMissionDesignVersion=735&ListAnimationVersion=695&ListAllResearchDesignVersion=512&ListAllTrainingDesignVersion=413&ListAllChallengeDesignVersion=560&ListAllRewardDesignVersion=289851&ListAllDivisionDesignVersion=498&ListAllCollectionDesignVersion=367&ListAllDrawDesignVersion=335&ListAllPromotionDesignVersion=959&ListAllSituationDesignVersion=453&ListAllTaskDesignVersion=0&ListActionTypeVersion=0&ListConditionTypeVersion=0&ListItemDesignActionVersion=65&ListSeasonDesignVersion=65&ListAssetVersion=51&ListMarkerGeneratorDesignVersion=33"
        r = self.request(url, "GET")
